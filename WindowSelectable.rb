class WindowSelectable < WindowBase
  ...
  def draw
    ...
    for i in 0..@options.length - 1
      @font.draw_rel(@options[i], @width / @column_num * (i % @column_num + 0.5), (@y + @height / (@options.length.to_f / @column_num).ceil) / 2 + i / @column_num * @line_height - @camera_y,  @z + 5, 0.5, 0.5) if @x >= 0 && @y >= 0
    end
  ...
  def draw_index
    ...
    @game.draw_quad(x + 10, y + 10, blue_border, x + width - 10, y + 10, blue_border, x + width - 10, y + @line_height - 10, blue_border, x + 10, y + @line_height - 10, blue_border, @z + 9)          
    @game.draw_quad(x + 11, y + 11, blue2, x + width - 11, y + 11, blue2, x + width - 11, y + @line_height - 11, blue2, x + 11, y + @line_height - 11, blue2, @z + 10)
